export class BrandDITokens {
  ...
  public static readonly CreateAddonCategoryUseCase: unique symbol = Symbol(
    "CreateAddonCategoryUseCase",
  );
  ...
  public static readonly AddonCategoryRepository: unique symbol = Symbol(
